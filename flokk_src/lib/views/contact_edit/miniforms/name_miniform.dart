...
class ContactNameMiniForm extends BaseMiniForm {
  ContactNameMiniForm(ContactEditFormState form, {Key? key}) : super(form, ContactSectionType.name, key: key);
        ...
        return Builder(
          builder: (context) => SeparatedColumn(
            ...
            children: <Widget>[
              ...
              buildTextInput(context, "Last Name", c.nameFamily, (v) => c.nameFamily = v),
              buildDualTextInput(context, "Prefix", c.namePrefix, (v) => c.namePrefix = v, "Suffix", c.nameSuffix,
                  (v) => c.nameSuffix = v),
            ],
