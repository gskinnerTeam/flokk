...
class ContactJobMiniForm extends BaseMiniForm {
  ContactJobMiniForm(ContactEditFormState form, {Key? key}) : super(form, ContactSectionType.job, key: key);
      ...
      formBuilder: () {
        ...
        return Builder(
          builder: (context) => SeparatedColumn(
            children: <Widget>[
              buildTextInput(context, "Company", c.jobCompany, (v) => c.jobCompany = v, autoFocus: isSelected),
              buildTextInput(context, "Job Title", c.jobTitle, (v) => c.jobTitle = v),
            ],
