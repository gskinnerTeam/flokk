      ...
      children: <Widget>[
        ...
        [
          Text(
            ...
            style: TextStyles.CalloutFocus.bold.size(24).textColor(Colors.white),
        ...
        kIsWeb
            ? Image.asset("assets/images/google-signin.png", height: 50).gestures(onTap: state.handleStartPressed)
            : PrimaryTextBtn(
                "LET'S START!",
                bigMode: true,
