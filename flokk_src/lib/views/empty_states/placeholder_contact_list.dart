...
class ContactListPlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var bgImage = Image.asset("assets/images/empty-noresult-bg@2x.png", height: 108, color: theme.bg2)
        .translate(offset: const Offset(8, 2));
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      PlaceholderImageAndBgStack("noresult-owl", bgWidget: bgImage, height: 126, top: 15, left: -30),
      const VSpace(Insets.l),
      isSearching
          ? const EmptyStateTitleAndClickableText(
              title: "NO RESULTS IN YOUR CONTACTS",
              startText: "We couldn't find any results that matched your search.\nPlease try another search.",
            )
